...
> **Owner**: VisualizationAgent（Claude 代持）
> **合稿时间**: 2026-04-22
...
| 08 | `08-agent-team-deps.mmd` | 12 meta-agent 依赖 | 1800×1000 | 内部文档 / AI Contribution Statement |
...
| 13 | `13-solo-workload.mmd` | Solo 模式工作量饼图 | 1400×1400 | AI Contribution Statement |
...
- 策略源文档：`docs/strategies/策略总览.md` / `一页纸决策清单.md`
